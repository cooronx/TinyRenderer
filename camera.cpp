...
namespace renderer {
    renderer::Camera::Camera(Eigen::Vector3f camera_pos, Eigen::Vector3f camera_target, Eigen::Vector3f world_up):camera_pos_(std::move(camera_pos)),
                            camera_target_(std::move(camera_target)),world_up_(std::move(world_up)) {
